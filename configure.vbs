...
WScript.Echo
WScript.Echo
WScript.Echo "This script will configure vNext RDK build to the"
...
Sub CreateIcon(base)
	...
	set oShellLink = WshShell.CreateShortcut(base & "\vNext RDK 2.0.lnk")
	...
	oShellLink.IconLocation = runningFrom & "\vNext.ico"
	oShellLink.Description = "Microsoft Research vNext environment build window"
