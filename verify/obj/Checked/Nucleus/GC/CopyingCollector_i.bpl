...
procedure GarbageCollect();
  ...
  modifies $toAbs, CurrentStack, $gcSlice, BF, BT, HeapLo, Fi, Fk, Fl, Ti, Tj, Tk, Tl, $stackState, $r1, $r2, $freshAbs, $Time, $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, $SectionMem;
...
procedure writeField($ptr:int, $fld:int, $val:int, $abs:int) returns ($_mem:[int]int, $_absMem:[int][int]int);
  ...
  modifies CurrentStack, $gcSlice, BF, BT, HeapLo, Fi, Fk, Fl, Ti, Tj, Tk, Tl, $stackState, $r1, $r2, $freshAbs, $Time, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem; // ... but don't modify $Mem
  ensures  gcAddr($ptr + 4 * $fld);
  ensures  word($val);
  ensures  $_mem == $Mem[$ptr + 4 * $fld := $val];
  ensures  $_absMem == $AbsMem[$toAbs[$ptr] := $AbsMem[$toAbs[$ptr]][$fld := $abs]];
  ensures  NucleusInv($S, $StackState, $toAbs, $_absMem, CurrentStack, $gcSlice, BF, BT, HeapLo, Fi, Fk, Fl, Ti, Tj, Tk, Tl, $_mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, $FrameCounts, $FrameAddrs, $FrameLayouts, $FrameSlices, $FrameAbss, $FrameOffsets, $IoMmuEnabled, $PciConfigState, DmaAddr);
...
procedure writeStack(
  ...
  requires isStack($S) && $StackState[$S] == StackRunning;
  requires NucleusInv($S, $StackState, $toAbs, $AbsMem, CurrentStack, $gcSlice, BF, BT, HeapLo, Fi, Fk, Fl, Ti, Tj, Tk, Tl, $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi,
  ...
  ensures  !gcAddrEx($ptr);
  ensures  word($val);
  ensures  NucleusInv($S, $StackState, $toAbs, $AbsMem, CurrentStack, $gcSlice, BF, BT, HeapLo, Fi, Fk, Fl, Ti, Tj, Tk, Tl, $_mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi,
