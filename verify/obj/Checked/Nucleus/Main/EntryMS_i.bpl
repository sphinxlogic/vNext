...
procedure NucleusEntryPoint($smap:int);
  ...
  modifies $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, CurrentStack, $gcSlice, $color, StackTop, $fs, $fn, CachePtr, CacheSize, ColorBase, HeapLo, HeapHi, ReserveMin, $stackState, $r1, $r2, $freshAbs, $Time, $toAbs;
...
procedure FaultHandler($_stackState:[int]StackState, $ebp:int, $esp:int, $eip:int);
  ...
  ensures  (StackStateTag($StackState[?InterruptStack]) == ?STACK_YIELDED ==>
               NucleusInv(?InterruptStack, $_stackState, $toAbs, $AbsMem, CurrentStack, $gcSlice, $color, StackTop, $fs, $fn, CachePtr, CacheSize, ColorBase, HeapLo, HeapHi, ReserveMin, $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, $FrameCounts, $FrameAddrs, $FrameLayouts, $FrameSlices, $FrameAbss, $FrameOffsets, $IoMmuEnabled, $PciConfigState, DmaAddr)
            && ebp == $ebp
            && esp == $esp);
...
procedure YieldTo($s:int, $_stackState:[int]StackState,
  ...
  ensures  ($StackState[$s] == StackRunning ==>
               NucleusInv($s, $StackState, $toAbs, $AbsMem, CurrentStack, $gcSlice, $color, StackTop, $fs, $fn, CachePtr, CacheSize, ColorBase, HeapLo, HeapHi, ReserveMin, $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, $FrameCounts, $FrameAddrs, $FrameLayouts, $FrameSlices, $FrameAbss, $FrameOffsets, $IoMmuEnabled, $PciConfigState, DmaAddr)
            && ebp == old(ebp)
            && esp == old(esp) + 4);
  ensures  ($StackState[$s] == StackYielded($ebp, $esp, $eip) ==>
               NucleusInv($s, $_stackState, $toAbs, $AbsMem, CurrentStack, $gcSlice, $color, StackTop, $fs, $fn, CachePtr, CacheSize, ColorBase, HeapLo, HeapHi, ReserveMin, $Mem, $sMem, $dMem, $pciMem, $tMems, $fMems, $gcMem, SLo, DLo, PciLo, TLo, FLo, GcLo, GcHi, $FrameCounts, $FrameAddrs, $FrameLayouts, $FrameSlices, $FrameAbss, $FrameOffsets, $IoMmuEnabled, $PciConfigState, DmaAddr)
            && ebp == $ebp
            && esp == $esp);
