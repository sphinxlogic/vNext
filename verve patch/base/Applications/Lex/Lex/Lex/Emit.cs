...
private void print_details()
  ...
  for (i = 0; i < spec.row_map.Length; ++i)
    {
    System.Console.Write("State " + Int32.ToString(i));
...
private void States()
  ...
  for (int index = 0; index < spec.state_dtrans.Length; ++index)
    {
    outstream.Write("  " + Int32.ToString(spec.state_dtrans[index]));
...
private void RMap_table()
  ...
  for (int i = 0; i < size; ++i)
    {
    outstream.Write(Int32.ToString(spec.row_map[i]));
    if (i < lastelem)
      outstream.Write(",");
    if (((i + 1) % 8) == 0)
      outstream.Write("\n  ");
...
private void Driver()
  ...
  string state_str = "";
    ...
    state_str =
      "  System.Console.WriteLine(\"\\n\\nCurrent state: \" + int.ToString(yy_state));\n"
    + "  System.Console.Write(\"Lookahead input: "
    + "   (\" + System.Convert.ToInt32(yy_lookahead).ToString() + \")\");\n"
    + "  if (yy_lookahead < 32)\n"
    + "    System.Console.WriteLine("
    ...
    + "  System.Console.WriteLine(\"State = \"+ int.ToString(yy_state));\n"
    + "  System.Console.WriteLine(\"Accepting status = \"+ int.ToString(yy_this_accept));\n"
      + "  System.Console.WriteLine(\"Last accepting state = \"+ int.ToString(yy_last_accept_state));\n"
      + "  System.Console.WriteLine(\"Next state = \"+ int.ToString(yy_next_state));\n"
;
#endif
  ...
  outstream.Write(hdr_str
    ...
    + "          if (yy_last_accept_state < " +
		  Int32.ToString(spec.accept_list.Count)
		  + ")\n"
