...
private void minimize()
  ...
  Console.WriteLine(Int32.ToString(group.Count) + " states after removal of redundant states.");
...
private void pset(ArrayList dtrans_group)
  ...
  for (int i = 0; i < size; ++i)
    ...
    Console.Write(Int32.ToString(dtrans.GetLabel()) + " ");
    }
  }
...
private void pgroups()
  ...
  for (int i = 0; i < group_size; ++i)
    {
    Console.Write("\tGroup " + Int32.ToString(i) + " {");
  ...
  for (int i = 0; i < dtrans_size; ++i)
    {
    Console.WriteLine("\tstate " + Int32.ToString(i)
		      + " is in group " + Int32.ToString(ingroup[i]));
    }
  }
}
}
