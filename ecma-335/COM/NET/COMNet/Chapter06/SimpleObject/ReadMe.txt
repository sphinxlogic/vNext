========================================================================
    ACTIVE TEMPLATE LIBRARY : SimpleObject Project Overview
========================================================================

AppWizard has created this SimpleObject project for you to use as the starting point for
...
_SimpleObject.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_SimpleObject.h)
        GUID definitions                                (_SimpleObject_i.c)
        A type library                                  (_SimpleObject.tlb)
        Marshaling code                                 (_SimpleObject_p.c and dlldata.c)
SimpleObject.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named SimpleObject.pch and a precompiled types file named StdAfx.obj.
...
SimpleObjectps.vcproj
	...
	dlldata.c, SimpleObject_i.c and SimpleObject_p.c which are required
