...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((ISimplest*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> get_X((ISimplest *) ((CStdStubBuffer *)This)->pvServerObject,pVal);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((ISimplest*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> put_X((ISimplest *) ((CStdStubBuffer *)This)->pvServerObject,newVal);
...
/* Object interface: ISimplest, ver. 0.0,
   GUID={0xFE19D164,0xDB7D,0x4A17,{0x8D,0x99,0xDF,0xD5,0x7F,0xB6,0x9E,0x02}} */
...
static const MIDL_SERVER_INFO ISimplest_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(10) _ISimplestProxyVtbl = 
{
    &IID_ISimplest,
    ...
    ISimplest_get_X_Proxy ,
    ISimplest_put_X_Proxy ,
...
static const PRPC_STUB_FUNCTION ISimplest_table[] =
{
    ...
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    ISimplest_get_X_Stub,
    ISimplest_put_X_Stub,
...
const CInterfaceProxyVtbl * __SimpleObject_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISimplestProxyVtbl,
    0
};

const CInterfaceStubVtbl * __SimpleObject_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISimplestStubVtbl,
    0
};

PCInterfaceName const __SimpleObject_InterfaceNamesList[] = 
{
    "ISimplest",
    0
};

const IID *  __SimpleObject_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __SimpleObject_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __SimpleObject, pIID, n)

int __stdcall __SimpleObject_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__SimpleObject_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _SimpleObject_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __SimpleObject_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __SimpleObject_StubVtblList,
    (const PCInterfaceName * ) & __SimpleObject_InterfaceNamesList,
    (const IID ** ) & __SimpleObject_BaseIIDList,
    & __SimpleObject_IID_Lookup, 
    1,
    1,
